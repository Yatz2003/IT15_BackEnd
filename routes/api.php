...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::post('/remove', [EnrollmentController::class, 'remove']);
    Route::get('/reports', [ReportController::class, 'index']);
    Route::get('/reports/enrollment-summary', [ReportController::class, 'enrollmentSummary']);
    Route::get('/reports/program-distribution', [ReportController::class, 'programDistribution']);
    Route::get('/reports/attendance-summary', [ReportController::class, 'attendanceSummary']);

    Route::get('/dashboard/overview', [DashboardController::class, 'overview']);
    Route::get('/dashboard/summary', [DashboardController::class, 'summary']);
    Route::get('/dashboard/calendar-summary', [DashboardController::class, 'calendarSummary']);
